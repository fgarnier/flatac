...
\begin{itemize}
\item Ph.D. in computer Sciences; Institut National Polythechique de Lorraine, INRIA-Lorraine. 
 \begin{itemize}
...
\frame{
\frametitle{About what I like}
\begin{block}{}
\begin{itemize}
\item Modeling and analysing systems and programs
\item Designing analysis methods
\item Working in a stimulating and rich environment 
\item Working with skilled people 
\end{itemize}
\end{block}
}
...
\begin{itemize}
\item The vertices are statement id labelled with SSL formula.
...
\begin{itemize}
\item Sort states w.r.t. they are valid, final or erroreous.
...
is the most general formula associated to $sid_i$ (Entailement Relation).
...
\section{Developpement and Current State of Flata-c}
\frame{\sectionpage}
...
\begin{block}{Currently implemented}
  \begin{itemize}
    \item Assert checking on first order arithemtic. 
    \item Funtion calls with scalar values and pointers.
...
\begin{block}{Current developpment}
  \begin{itemize}
...
\frame{
  \begin{block}{}
    \begin{itemize}
      \item Incrementally adding features led to some desing inconsistancies
      ...
      \item Not casually evaluting how long it takes to achieve a task.
      \end{itemize}
  \end{block}
